<script>
    ...
    <HeroSection>
        <h1 class="">ERROR WHILE</h1>
        <h1 class="mb-l">PURCHASING</h1>
        <p class="light-grey mb-s">
            We're sorry, but it looks like there was an error while processing your purchase. Don't 
        ...
        <p class="light-grey mb-s">
            ...
            We’re committed to ensuring that you get the guide you need to make your move to Spain 
